...
img_norm_cfg = dict(
    mean=[128.0673960808648, 97.9796109483507, 46.87812790595161],
    std=[39.186602940773604, 57.02598687059756, 38.08154291098779],
    to_rgb=False)
train_pipeline = [
            ...
            dict(
                ...
                transforms=[
                    ...
                    dict(
                        type='Normalize',
                        mean=[
                            128.0673960808648, 97.9796109483507,
                            46.87812790595161
                        ],
                        std=[
                            39.186602940773604, 57.02598687059756,
                            38.08154291098779
                        ],
                        to_rgb=False),
                    dict(type='Pad', size_divisor=32),
...
model = dict(
    ...
    test_cfg=dict(
        ...
        rcnn=dict(
            ...
            max_per_img=1500)))
work_dir = './work_dirs/phase1_vt_normal'
auto_resume = False
gpu_ids = [0]
