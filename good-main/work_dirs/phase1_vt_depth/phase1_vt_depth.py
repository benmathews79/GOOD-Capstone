...
img_norm_cfg = dict(
    mean=[90.60182726478577, 154.72737057113648, 103.93106789970398],
    std=[58.974063945533835, 62.910045863289064, 38.54497082175815],
    to_rgb=False)
train_pipeline = [
    ...
    dict(
        ...
        transforms=[
            ...
            dict(
                type='Normalize',
                mean=[
                    90.60182726478577, 154.72737057113648, 103.93106789970398
                ],
                std=[
                    58.974063945533835, 62.910045863289064, 38.54497082175815
                ],
                to_rgb=False),
            dict(type='Pad', size_divisor=32),
            ...
            dict(
                ...
                transforms=[
                    ...
                    dict(
                        type='Normalize',
                        mean=[
                            90.60182726478577, 154.72737057113648,
                            103.93106789970398
                        ],
                        std=[
                            58.974063945533835, 62.910045863289064,
                            38.54497082175815
                        ],
                        to_rgb=False),
                    dict(type='Pad', size_divisor=32),
...
model = dict(
    ...
    test_cfg=dict(
        ...
        rcnn=dict(
            ...
            max_per_img=1500)))
work_dir = './work_dirs/phase1_vt_depth'
auto_resume = False
gpu_ids = [0]
