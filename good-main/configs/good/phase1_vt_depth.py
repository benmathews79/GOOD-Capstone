...
model = dict(
    ...
    neck=dict(
        ...
        out_channels=256,
        num_outs=5),  # add extra levels (input only 4 levels; the 5th output level comes from maxpool2d of the last input level)
    rpn_head=dict(
        type='OlnRPNHead',
        in_channels=256,
        feat_channels=256,
...
img_norm_cfg = dict(
    mean=[90.60182726478577, 154.72737057113648, 103.93106789970398], std=[58.974063945533835, 62.910045863289064, 38.54497082175815], to_rgb=False)
train_pipeline = [
